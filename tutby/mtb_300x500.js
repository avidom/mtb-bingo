...
p.nominalBounds = new cjs.Rectangle(-143,-13,287,26);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(0,233.5);

	this.timeline.addTween(cjs.Tween.get(this.btn).wait(1));

	// sroki
	this.sroki = new lib.Symbol74();
	this.sroki.setTransform(0,292);
	this.sroki.alpha = 0.602;

	this.timeline.addTween(cjs.Tween.get(this.sroki).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-143,-154.6,287,459.6);
